...
/* Datum, čas, číslo a firmu z cizího souboru převádějí sdílené funkce
   import_datum(), import_cas(), import_cislo() a import_firma()
   v pomocnici.php — používá je i napojení na Airtable. */
